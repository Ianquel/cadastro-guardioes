...
SENHA_REMETENTE = "fbqx ikou jwdg qepn"  # Senha de app do Gmail
...
st.markdown(
    ...
    <div style="text-align: center;">
        <img src="logo_guardioes.png" width="350">
...
with st.form("formulario_cadastro"):
    ...
    email_atleta = st.text_input("E-mail do Atleta")  # NOVO CAMPO
    rg = st.text_input("RG")
    ...
    if enviado:
        if not all([nome, email_atleta, rg, orgao_emissor, cpf, data_nascimento, foto, declaracao]):
